...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-08-2015 a las 12:54:51
...
CREATE TABLE IF NOT EXISTS `cad001` (
  ...
  `fecinc` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Fecha de inclusion',
  `estatus` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'A' COMMENT 'Estado del usuario',
  `fecest` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Fecha de estado',
  `observ` char(60) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Fecha del estado',
  `tipou` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'U' COMMENT 'Tipo de usuario',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='usuarios';

--
-- Volcado de datos para la tabla `cad001`
--

INSERT INTO `cad001` (`uid`, `login`, `passwd`, `cedula`, `nombre`, `fecinc`, `estatus`, `fecest`, `observ`, `tipou`, `codigo2`, `email`) VALUES
(1, 'root', '202cb962ac59075b964b07152d234b70', '10000001', 'administrador', '2015-07-30 06:42:41', '1', '2015-07-30 02:12:41', '1', '1', NULL, NULL),
(2, 'hector', 'e10adc3949ba59abbe56e057f20f883e', '13646179', 'hector gonzalez', '2015-07-12 19:19:01', '1', '2015-07-12 00:00:00', 'desarrollador n 1', '1', NULL, 'greathector7@gmail.com'),
(3, 'LGARCIA', 'ccb0989662211f61edae2e26d58ea92f', '14470755', 'LEIDY GARCIA', '2015-07-12 22:49:35', '1', '0000-00-00 00:00:00', 'COORDINADORA DESAROLLO INSTITUCIONAL', '1', '1', 'APOYOACADEMICOMSARAGUA@GMAIL.COM'),
(4, 'GBOLIVAR', 'e10adc3949ba59abbe56e057f20f883e', '14683669', 'GRELYS BOLIVAR', '2015-07-12 22:48:37', '1', '0000-00-00 00:00:00', 'CARGA BASICA DEL SISTEMA', '1', '1', 'GRELYSDAYANA220280@GMAIL.COM'),
(5, 'antorcha', '202cb962ac59075b964b07152d234b70', '123457', 'antorcha ñ', '2015-08-02 20:50:16', '1', '2015-08-02 16:20:16', '1', '1', '1', '123@gmail.com'),
(6, 'peluza', '202cb962ac59075b964b07152d234b70', '1234561', 'jose peluche', '2015-07-12 21:12:24', '1', '0000-00-00 00:00:00', '1', '1', '1', 'greathector7@gmail.com'),
(7, 'MESCOBAR', 'c4ca4238a0b923820dcc509a6f75849b', '4422123', 'MAURICIO ESCOBAR', '2015-07-12 22:54:24', '1', '0000-00-00 00:00:00', 'COORDINADOR GENERAL', '1', '1', 'CRMSARAGUA@GMAIL.COM'),
(8, 'VRAMOS', 'c4ca4238a0b923820dcc509a6f75849b', 'E6XYHD67', 'VILMA RAMOS', '2015-07-12 22:55:54', '1', '0000-00-00 00:00:00', 'ASESORA CUBANA', '1', '1', 'VILMAHJE@GMAIL.COM'),
(9, 'hgonzalez', '123', '1364619', 'hector2 gonzalez', '2015-08-11 01:26:44', 'A', '2015-08-10 20:56:44', 'director de informatica', 'U', NULL, 'greathector7@gmail.com');
...
CREATE TABLE IF NOT EXISTS `cad001a1` (
  `id` int(11) NOT NULL COMMENT 'id del estatus',
...
INSERT INTO `cad001a1` (`id`, `nom_estatus`) VALUES
(1, 'Activo'),
(2, 'Inactivo');
...
--
ALTER TABLE `cad001`
  MODIFY `uid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador usuario',AUTO_INCREMENT=10;
--
